...
cast-audio itself is MIT licensed (see [LICENSE](LICENSE)). It redistributes one
...
| [catt](https://github.com/skorokithakis/catt) / [pychromecast](https://github.com/home-assistant-libs/pychromecast) | MIT | `scripts/scan.py` and `scripts/caster.py` run on catt's Python, which supplies pychromecast. |
